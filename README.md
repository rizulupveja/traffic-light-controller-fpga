...
- FPGA Development Board (Target Hardware)
- Computer/Laptop
...
```bash
git clone https://github.com/rizulupveja/traffic-light-controller-fpga.git
```

2. Open the project in **Xilinx Vivado**.

3. Add the Verilog source files and testbench.

4. Run **Behavioral Simulation**.

5. Observe the waveform generated by the simulator.

6. Verify the FSM state transitions and traffic light outputs.


## Future Improvements

The following enhancements can be incorporated into future versions of the project:

- Support for pedestrian crossing signals.
- Adaptive traffic signal timing based on traffic density.
